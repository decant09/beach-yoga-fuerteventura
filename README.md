...
- At lower screen sizes the map and form did not behave as expected. They would display as block elements as intended. However, they did not cover the entire screen width. I realized that my media query rule was targeting the correct title, however I was targeting an id selector as opposed to a class selector. After identifying this and tidying up some margin rules the issue was resolved.
